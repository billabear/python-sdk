...
class RefundsApi(object):
    ...
    def list_refund(self, **kwargs):  # noqa: E501
        """List  # noqa: E501

        List all refund  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_refund(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_refund_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_refund_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_refund_with_http_info(self, **kwargs):  # noqa: E501
        """List  # noqa: E501

        List all refund  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_refund_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def show_refund_by_id(self, refund_id, **kwargs):  # noqa: E501
        """Detail  # noqa: E501

        Info for a specific Refund  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.show_refund_by_id(refund_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str refund_id: The id of the refund (required)
        :return: Refund
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.show_refund_by_id_with_http_info(refund_id, **kwargs)  # noqa: E501
        else:
            (data) = self.show_refund_by_id_with_http_info(refund_id, **kwargs)  # noqa: E501
            return data

    def show_refund_by_id_with_http_info(self, refund_id, **kwargs):  # noqa: E501
        """Detail  # noqa: E501

        Info for a specific Refund  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.show_refund_by_id_with_http_info(refund_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method show_refund_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('refund_id' not in params or
            ...
            raise ValueError("Missing the required parameter `refund_id` when calling `show_refund_by_id`")  # noqa: E501
